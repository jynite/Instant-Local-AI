...
>>"%BOOTLOG%" echo.
>>"%BOOTLOG%" echo ============================================================
>>"%BOOTLOG%" echo [%DATE% %TIME%] Bootstrap action: stop
...
start "Local AI PowerShell" "%PWSH%" -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%RUNNER%" -Controller "%CONTROLLER%" -Action stop
