...
>>"%BOOTLOG%" echo.
>>"%BOOTLOG%" echo ============================================================
>>"%BOOTLOG%" echo [%DATE% %TIME%] Bootstrap action: install
...
start "Local AI PowerShell" "%PWSH%" -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%RUNNER%" -Controller "%CONTROLLER%" -Action install
