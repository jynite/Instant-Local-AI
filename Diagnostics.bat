...
>>"%BOOTLOG%" echo.
>>"%BOOTLOG%" echo ============================================================
>>"%BOOTLOG%" echo [%DATE% %TIME%] Bootstrap action: diagnostics
>>"%BOOTLOG%" echo Script dir: %SCRIPT_DIR%

echo Local AI bootstrap
echo Action: diagnostics
echo.
...
start "Local AI PowerShell" "%PWSH%" -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%RUNNER%" -Controller "%CONTROLLER%" -Action diagnostics
